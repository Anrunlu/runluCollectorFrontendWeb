    ...
    <q-header elevated class="bg-white text-grey-8" height-hint="64">
      <q-toolbar class="GPL__toolbar" style="height: 64px">
        ...
        <q-toolbar-title v-if="$q.screen.gt.sm" shrink class="row items-center no-wrap">
          ...
          <span class="q-ml-sm"><q-btn color="gray" flat label="工作台" to="/" /></span>
        </q-toolbar-title>
    ...
    >
      <q-scroll-area class="fit">
        ...
        <q-list padding>
          ...
          <q-item v-for="link in links3" :key="link.text" :to="link.to" clickable class="GPL__drawer-item">
            <q-item-section avatar>
              <q-icon :name="link.icon" />
            </q-item-section>
            <q-item-section>
  ...
  data () {
    return {
      ...
      links1: [
        ...
        { icon: 'create_new_folder', text: '创建收集', to: '/collection/create' }
      ],
      links2: [
